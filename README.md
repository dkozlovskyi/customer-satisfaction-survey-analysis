...
- `significant_change` - "yes" if |delta| is greater than group std dev, otherwise "no"
...
- |question_delta| > group_std_dev_delta

This helps identify questions with changes larger than the typical variability in their group.
